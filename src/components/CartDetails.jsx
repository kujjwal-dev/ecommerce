      ...
      <div className="col-md-8 mt-5 mb-5 cardsdetails">
        <div className="card">
          ...
          <div className="card-body p-0">
            {
               carts.length === 0 ? <table className="table cart mb-0">
                    <tbody>
                        <tr>
                            <td colSpan={6}>
                ...
                <table className="table cart-table mb-0 table-responsive-sm">
                    ...
                    <tfoot>
                        <tr>
                            <th>&nbsp;</th>
                            <th colSpan={3}>&nbsp;</th>
                            <th>Items In Cart <span className="ml-2 mr-2">:</span><span className="text">{totalquantity}</span></th>
                            <th className="text-right">Total Price <span className="ml-2 mr-2">:</span><span className="text">{totalprice}</span></th>
                        </tr>
                    </tfoot>
